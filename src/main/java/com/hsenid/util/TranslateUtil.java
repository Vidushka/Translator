...
public class TranslateUtil {
    ...
    public Languages getLanguages() {
        try {
            ...
            /*while (obj.keys().hasNext()){
                codes.add(String.valueOf(obj.keys()));
                langs.add(String.valueOf(obj.names()));
            }*/
    ...
    public Words translate(String inputLang, String outputLang, String wordToConvert) {
        try {
            URL url = new URL("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20170503T091519Z.9f30c24402100dfb.91f7ddaca07e07cddb27fd1cd769dd2b43d5c765&text=" + wordToConvert + "&lang=en-ja");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
